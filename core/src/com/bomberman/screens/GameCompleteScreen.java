 ...
 */
public class GameCompleteScreen implements Screen, InputProcessor {
     ...
     */
    public GameCompleteScreen(BomberMan game)
    {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        font.draw(game.batch, "Gratulacje, ukończyłeś gre!", camera.viewportWidth * 0.4f, camera.viewportHeight*0.8f);
